...
date = "2023-05-12" + " ";
segments = [
    [datetime(date + "10:57:46.304", "TimeZone", "UTC", "Format", 'yyyy-MM-dd HH:mm:ss.SSSSSSSSS'), datetime(date + "10:57:47.00405", "TimeZone", "UTC", "Format", 'yyyy-MM-dd HH:mm:ss.SSSSSSSSS')];
    [datetime(date + "10:57:53.3543", "TimeZone", "UTC", "Format", 'yyyy-MM-dd HH:mm:ss.SSSSSSSSS'), datetime(date + "10:57:54.1144", "TimeZone", "UTC", "Format", 'yyyy-MM-dd HH:mm:ss.SSSSSSSSS')];
    [datetime(date + "10:58:00.90465", "TimeZone", "UTC", "Format", 'yyyy-MM-dd HH:mm:ss.SSSSSSSSS'), datetime(date + "10:58:01.4947", "TimeZone", "UTC", "Format", 'yyyy-MM-dd HH:mm:ss.SSSSSSSSS')]
];
...
%     Save segments to csv
    ...
    finalized_path = dir_finalized_files + filesep + "bas-on-gain-8" + filesep + file_name + "-bas-on-gain-8-speed-6";
